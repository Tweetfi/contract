...
// File: contracts/Tweetfi_code.sol123
...
contract Tweetfi is ERC20, Pausable, Ownable {
    using SafeMath for uint256;
    IPancakeRouter02 private pancakeV2Router = IPancakeRouter02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 _ethAmount) private {
        _approve(address(this), address(pancakeV2Router), tokenAmount);
        pancakeV2Router.addLiquidityETH{value: _ethAmount}(
            address(this),
            tokenAmount,
            0,
            0,
